...
#######################################################################
def create_validation_set(x_train, y_train, n, seed=12357, imbalance=False):
	...
	if imbalance:
		...
		assert numpy.testing.assert_allclose(ratios, sample_ratios) is None,\
...
#######################################################################
def write_validation_set(x_train, y_train, n, suffix, seed=12357, imbalance=False):
	
	logger = logging.getLogger(__name__)

	index = create_validation_set(x_train, y_train, n, seed=12357, imbalance=False)
