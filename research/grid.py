#!/home/marcin/workspace/pyenvs/aml/bin/python3.7
...
import traceback, getpass, time, re
...
def find_parameters(dataset_pathname, options=''):
    ...
    with open(dataset_pathname+"_grid_search", 'w') as f:
        for line in jobs:
            for (c,g) in line:
                while (c,g) not in done_jobs:
                    ...
                    if (c1,g1) not in resumed_jobs:
                        ...
                        f.write("%s, %s, %s, %s, %s, %s\n" % (c1, g1, rate1, best_c, best_g, best_rate))
